...
--%>
<%@ page import="com.soft.book.model.vo.UserVO" %>
<%@ page import="com.soft.book.model.entity.User" %>
    ...
    <div class="col-4">
      ...
      <div class="item">
        ...
        <div class="read">
          ...
          <p style="color: #9b9b9b;">2024年9月19日</p>
        </div>
        <div class="read">
          <p><a href="">${user.nickname}</a> 想读
            <a href="">写给大忙人的Java SE 8</a>
          </p>
          <p style="color: #9b9b9b;">2024年9月20日</p>
        </div>
      </div>
    </div>
  </div>
